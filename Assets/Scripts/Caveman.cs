...
public class Caveman : MonoBehaviour
{
    ...
    private float _deltaPositionX = 0.07f;
    private float _deltaPositionY = 0.15f;
    private float _radiusCollider = 0.26f;
    ...
    {   
        float positionColliderX = transform.position.x + _deltaPositionX;
        float positionColliderY = transform.position.y + _deltaPositionY;
        Collider2D[] colliders = Physics2D.OverlapCircleAll(new Vector3(positionColliderX, positionColliderY), _radiusCollider, _ground);
